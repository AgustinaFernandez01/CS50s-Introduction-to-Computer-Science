...
def index():
    ...
    for stock in stocks:
        ...
        stock["price"] = usd(quote["price"])  # Format price using usd function
        stock["value"] = usd(quote["value"])  # Format value using usd function
        total_value += quote["value"]
        grand_total += quote["value"]

    cash = usd(cash)  # Format cash using usd function
    total_value = usd(total_value)  # Format total_value using usd function
    grand_total = usd(grand_total)  # Format grand_total using usd function
